...
![P-v Diagram]({{ "/assets/images/Pv_diagram.jpeg" | absolute_url }}){: style="width: 500px"}

## The T-s Diagram

![T-s Diagram]({{ "/assets/images/Ts_diagram.jpeg" | absolute_url }}){: style="width: 500px"}

## Work and Heat for Each Process

![Work and Heat Equations]({{ "/assets/images/work_heat_equations.png" | absolute_url }}){: style="width: 500px"}
...
For a piston engine, over a full cycle the engine returns to its initial state. Therefore, there is no net mass accumulation.
...
$$
\frac{dE_{CV}}{dt} = \sum \dot{Q} - \sum \dot{W}
